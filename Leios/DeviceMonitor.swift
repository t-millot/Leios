// DeviceMonitor.swift
// Leios — the live device list and the watcher that marks the mouse in the user's hand.
...
final class DeviceMonitor {
    ...
    /// keys per-device click cycles on; see EventUtility.kLeiosCGEventFieldSenderID. The app target
    /// can't import LeiosEngine, so the number is repeated here rather than shared.
