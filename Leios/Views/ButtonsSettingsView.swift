...
// Leios — per-button click / hold / drag assignments.
...
struct ButtonsSettingsView: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            HStack {
                Menu("Presets") {
                    Button("5-button mouse") { model.config.buttons = LeiosConfig.fiveButtonPreset }
                    Button("3-button mouse") { model.config.buttons = LeiosConfig.threeButtonPreset }
