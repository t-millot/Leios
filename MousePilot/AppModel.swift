// AppModel.swift
// MousePilot — observable app state: config document, helper installation and live status.
...
enum HelperState: Equatable {
    ...
    var description: String {
        switch self {
        case .disabled: return "MousePilot is off."
...
final class AppModel {
    ...
    init() {
        config = (try? ConfigFile.load()) ?? MousePilotConfig()
