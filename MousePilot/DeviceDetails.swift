// DeviceDetails.swift
// MousePilot — turning a device's properties into the rows the Info tab lists.
...
extension DeviceDetailGroup {
    ...
    /// The four groups, ordered by what a MousePilot user is most likely to be looking for rather
    ...
    static func groups(entryID: UInt64,
        ...
        [DeviceDetailGroup(id: "mousepilot", title: "What MousePilot Does",
                           rows: mousePilotRows(entryID: entryID, elements: elements, engineHandling: engineHandling)),
    ...
    private static func mousePilotRows(entryID: UInt64,
                                       elements: HIDElementSummary,
                                       engineHandling: EngineHandling) -> [DeviceDetail] {
        var collector = RowCollector()
        collector.add("handling", "Affected by MousePilot", engineHandling.summary)
    ...
    private static func buttonSummary(_ elements: HIDElementSummary) -> String? {
        ...
        guard elements.highestButton >= MPConstants.minButton else {
